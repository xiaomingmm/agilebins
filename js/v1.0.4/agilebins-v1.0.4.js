...
;(function ($) {
    $.fn.agilebins = function (_arg_options, _evt) {
        ...
        var __rtnObject = {"slide": [], "mPrev": [], "mNext": [], "scroll": [], "sPrev": [], "sNext": [], "el": []};
        __rtnObject.el = this.each(function (__eachIndex, __eachEl) {
            ...
            var f_scrollMarquee = function (__init, __sdir, __dtime) {
                ...
                if (__init) {
                    var __tvs = (_direction == f_dir("l") || _direction == f_dir("r") ? [_AB_TV_.sw, _AB_TV_.l] : [_AB_TV_.sh, ""]);
                    _sMarquee = _scrollBox.parent(".sTempWrap");
                    _sMarquee.wrapInner("<div class=\"sTempWrapInner\" style=\"" + __tvs[0] + ":100000%;\"></div>");
                    if (_AB_TV_.l == __tvs[1]) {
                        _scrollBox.css("float", _AB_TV_.l);
                        _sMarquee.width("100%");
                        _sMarquee.children().css(_AB_TV_.sw, f_px(_scrollBox.outerWidth(true) * 2.5));
                        ...
                        _sMarquee.children().css(_AB_TV_.sh, f_px(_scrollBox.outerHeight(true) * 2.5));
                        if (_scrollBox.outerHeight(true) <= _sMarquee.outerHeight()) {
                            _autoPlay = false;
                            return false
                        }
                    }
                    if (_direction == _AB_TV_.r) {
                        var __sBoxTempLeft = 0 - (_scrollBox.outerWidth(true) - _sMarquee.outerWidth());
                        _scrollBox.css(_AB_TV_.l, f_px(__sBoxTempLeft))
                    }
                    if (_direction == _AB_TV_.b) {
                        var __sBoxTempTop = 0 - (_scrollBox.outerHeight(true) - _sMarquee.outerHeight());
                        _scrollBox.css(_AB_TV_.t, f_px(__sBoxTempTop))
                    }
            ...
            var f_makeReturn = function () {
                __rtnObject.slide[__eachIndex] = function (__eIndex) {
                    f_slideDo(__eIndex)
                };
                __rtnObject.mPrev[__eachIndex] = function () {
                    f_mPrevDo()
                };
                __rtnObject.mNext[__eachIndex] = function () {
                    f_mNextDo()
                };
                __rtnObject.scroll[__eachIndex] = function (__ePage) {
                    f_scrollDo(__ePage)
                };
                __rtnObject.sPrev[__eachIndex] = function () {
                    f_sPrevDo()
                };
                __rtnObject.sNext[__eachIndex] = function () {
                    f_sNextDo()
                }
            };
            f_appCreate();
